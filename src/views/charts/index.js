...
export {default as HistoryWeather} from './HistoryWeatherChart';
export {default as NdviChart} from './NdviChart';
export {default as HistorySoilChart} from './HistorySoilChart';
